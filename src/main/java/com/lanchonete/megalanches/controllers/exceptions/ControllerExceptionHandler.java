package com.lanchonete.megalanches.controllers.exceptions;
...
public class ControllerExceptionHandler {
	...
	public ResponseEntity<StandardError> ResourceNotFound(NullPointerException e, HttpServletRequest request) {
